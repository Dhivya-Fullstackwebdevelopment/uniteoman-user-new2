            ...
            <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 56px', boxSizing: 'border-box' }}>
                <div style={{ maxWidth: '680px', margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                        ...
                        <div style={{ flex: 1, font: '700 18px/1 "DM Sans", sans-serif', color: '#0A0A0F' }}>
                            #UO-4601 — Receipt
                        </div>
                        <button
                    ...
                    <div style={{ background: 'white', borderRadius: '20px', padding: '28px', boxShadow: '0 4px 20px rgba(0,0,0,.08)' }}>

                        {/* Brand Logo and Title Context Subheader */}
                        <div style={{ textAnatomy: 'center', textAlign: 'center', paddingBottom: '24px', borderBottom: '1px solid #EBEBEF', marginBottom: '24px' }}>
                        ...
                        <div style={{ background: '#F4F5F8', borderRadius: '14px', padding: '18px', marginBottom: '20px' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', margin_top: '14px', marginTop: '14px' }}>
